...
Insight: Strict synchronization (fsync) introduces a <!-- DYNAMIC:SYNC_TAX -->**454x**<!-- END_DYNAMIC --> performance floor limited by disk IOPS.
...
Insight: Increased concurrency leverages the leader-follower batching mechanism to deliver a <!-- DYNAMIC:GROUP_COMMIT -->**4.5x**<!-- END_DYNAMIC --> throughput amplification.
