...
Insight: Strict synchronization (fsync) introduces a <!-- DYNAMIC:SYNC_TAX -->**408x**<!-- END_DYNAMIC --> performance floor limited by disk IOPS.
...
Insight: Recovery time scales with the strictness of consistency checks, showing a <!-- DYNAMIC:RECOVERY_REDUCTION -->**2.5x**<!-- END_DYNAMIC --> reduction in MTTR with faster modes.
